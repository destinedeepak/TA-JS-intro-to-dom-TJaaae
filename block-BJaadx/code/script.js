...
console.log(`count of buttons: ${document.querySelectorAll('button').length}`)

// 18. Select all the `label` element and log the count.
console.log(`count of label: ${document.querySelectorAll('label').length}`)

// 19. Select all the elements with `id` of `test`
allElementWithIdText = document.querySelectorAll("#test")

// 20. Select the first element with id `test` using `getElementById`
fisrtElementWithIdText = document.getElementById("test")
