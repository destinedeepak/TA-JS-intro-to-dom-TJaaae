...
console.log(`The total number of img element is ${document.querySelector("img").childElementCount}`)

// 16. Select all the `p` element and store in `allPElement`
let allPElement = document.querySelectorAll("p")

// 17. Select all the buttons and log the count of buttons.
// console.log(`count of buttons${document.querySelectorAll('btn')}`)

// 18. Select all the `label` element and log the count.
console.log(`count of label: ${document.querySelectorAll('label').length}`)

// 19. Select all the elements with `id` of `test`
allPElementWithIdText = document.getElementById("test")
...
topics.previousSibling.innerText = "Learning About Walking the DOM"

// 24. Select the first element child of the element stored in `topics` variable (#5) and change the `innerText` property of the element to `This is the first child element`.
topics.firstChild.innerText = "This is the first child element"
